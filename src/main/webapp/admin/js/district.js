$(function(){
    //使用datagrid绑定数据展示
    $('#dg').datagrid({
        url:'districtAll',/* 这里的地址具有  唯一性。 所谓的唯一性是  目录和控制器下的英文单词一样那么就不需要写了。比如admin  */
        fitColumns: true,
        pagination: true,
        pageList: [5, 10, 15, 20],
        ...
        columns: [[
            ...
            { field: 'opt', title: '操作', width: 50, align: "center",
                formatter: function(value,row,index){
                    ...
                    return "<a href='javascript:delSingle("+row.id+")'>删除</a>|<a href='javascript:openStreet("+row.id+")'>查看街道</a>";
                }
            }
        ]]
    });
